...
enum class Plate(val weight: Double, val isMetric: Boolean, val color: String, val height: Int) {
    ...
    IMPERIAL_10(10.0, false, "#a7acb7", 125),
    IMPERIAL_25(25.0, false, "#10a845", 250),
    IMPERIAL_45(45.0, false, "#1026a8", 300),

    METRIC_1(1.0, true, "#7af441", 40),
    METRIC_1_25(1.25, true, "#417cf4", 50),
    METRIC_2_5(2.5, true, "#a7acb7", 60),
    METRIC_5(5.0, true, "#10a845", 75),
    METRIC_10(10.0, true, "#db8708", 150),
    METRIC_15(15.0, true, "#c60522", 250),
    METRIC_20(20.0, true, "#1026a8", 300);
